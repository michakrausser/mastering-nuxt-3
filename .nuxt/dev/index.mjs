globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///Users/michakrausser/Webstorm/mastering-nuxt-3/node_modules/node-fetch-native/dist/polyfill.mjs';
...
import { parseURL, withQuery, joinURL } from 'file:///Users/michakrausser/Webstorm/mastering-nuxt-3/node_modules/ufo/dist/index.mjs';
import destr from 'file:///Users/michakrausser/Webstorm/mastering-nuxt-3/node_modules/destr/dist/index.mjs';
import { snakeCase } from 'file:///Users/michakrausser/Webstorm/mastering-nuxt-3/node_modules/scule/dist/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file:///Users/michakrausser/Webstorm/mastering-nuxt-3/node_modules/ohmyfetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/michakrausser/Webstorm/mastering-nuxt-3/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/michakrausser/Webstorm/mastering-nuxt-3/node_modules/hookable/dist/index.mjs';
import { hash } from 'file:///Users/michakrausser/Webstorm/mastering-nuxt-3/node_modules/ohash/dist/index.mjs';
import { createStorage } from 'file:///Users/michakrausser/Webstorm/mastering-nuxt-3/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/michakrausser/Webstorm/mastering-nuxt-3/node_modules/unstorage/dist/drivers/fs.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/michakrausser/Webstorm/mastering-nuxt-3/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/michakrausser/Webstorm/mastering-nuxt-3","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/michakrausser/Webstorm/mastering-nuxt-3/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/michakrausser/Webstorm/mastering-nuxt-3/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/michakrausser/Webstorm/mastering-nuxt-3/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const errorHandler = (async function errorhandler(error, event) {
  ...
  if (!html) {
    const { template } = await import('file:///Users/michakrausser/Webstorm/mastering-nuxt-3/node_modules/@nuxt/ui-templates/dist/templates/error-dev.mjs') ;
    {
...
const getClientManifest = () => import('/Users/michakrausser/Webstorm/mastering-nuxt-3/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('/Users/michakrausser/Webstorm/mastering-nuxt-3/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
